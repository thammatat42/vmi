...
<head>
  ...
  <link rel="stylesheet" href="assets/css/auto-color-hover.css">
  <style>
    .gradient-text {
    ...
    <div class="row justify-content-right">
      <section class="col-lg-6">
        <div class="p-3 p-md-4 text-center">
          <h1 class="text-center text-primary font-weight-bold gradient-text"> VMI SYSTEM</h1>
          <h4 class="gradient-text">Vendor Management Inventory System</h4> 
          <img style="width: 200px; height: 200px;" src="assets/images/vmi3.png" alt="Preview">
        </div>
      </section>
      <section class="col-lg-6">
        <div class="card shadow p-3 p-md-4 blur">
          <h1 class="text-center text-primary font-weight-bold gradient-text"> <u>Sign IN</u></h1>
          ...
          <div class="card-body">
            ...
            <form id="formLogin">
              ...
              <div class="form-grop">
                <button type="submit" class="btn btn-block btn-gradient-border" id="button"> เข้าสู่ระบบ</button>
              </div>
              <hr>
              <div class="d-flex justify-content-center"> 
                <a class="color" href="recover.php">Forgot your password?</a> 
              </div>
