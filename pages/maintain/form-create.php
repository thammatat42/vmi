                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 px-1 px-md-5">
                                            ...
                                            <div class="form-group" id="min_hidden" hidden>
                                                <label for="min_stock">ปริมาณตํ่าสุด (Min-Stock)</label>
                                                <input type="text" class="form-control" name="min_stock" id="min_stock" placeholder="กรุณาใส่ค่า max">
                                            </div>
    ...
    $(function() {
        ...
        $('#formData').validate({
            ...
            messages: {
                ...
                max_stock: {
                required: "กรุณากำหนด Max stock",
                },
                min_stock: {
                required: "กรุณากำหนด Min stock",
                },
            },
            errorElement: 'span',
            errorPlacement: function (error, element) {
