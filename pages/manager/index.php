                        ...
                        <div class="card shadow">
                            <div class="card-header border-0 pt-4">
                                ...
                                <?php 
                                    ...
                                    <a href="upload-info.php" class="btn btn-warning mt-3">
                                        <i class="far fa-file-excel"></i>
                                        ลงทะเบียนเข้าสู่ระบบเเบบไฟล์
                                    </a>
                                <?php
                                    } 
                                ?>
                                <?php if($_SESSION['department'] == 'Business Application Department') { ?>
                                    <a href="upload-stt.php" class="btn btn-info mt-3">
                                        <i class="fas fa-user-plus"></i>
                                        เพิ่มข้อมูลพนักงานทั้งหมด
                                    </a>

                                    <a href="upload-calendar.php" class="btn btn-success mt-3">
                                        <i class="fas fa-calendar-plus"></i>
                                        เพิ่มข้อมูลปฏิทิน
                                    </a>
                                <?php } ?>
                                <?php if($_SESSION['gid'] == '22150316' || $_SESSION['gid'] == '22210064') { ?>
                                    <a href="reset-password.php" class="btn btn-danger mt-3">
