                    ...
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-header border-0 pt-4">
                                ...
                                <a href="../../assets/template/master_list.csv" class="btn btn-success my-3 float-sm-right" download>
...
<script>
    $('#submit_form').on('submit', function(e) {
        ...
        $.ajax({  
            type: "POST",  
            url: "../../service/upload/upload_list.php",
            data: formData,
            contentType: false,
            processData: false
        }).done(function(resp) {
