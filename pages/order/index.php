...
// die();
    ...
    if($_SESSION['department'] == 'Changeable Lens Production I Department' || $_SESSION['department'] == 'Changeable Lens Production II Department' || $_SESSION['department'] == 'Lens Engineering Division'
    || $_SESSION['department'] == 'Lens Process Engineering Department' || $_SESSION['department'] == 'Lens Production Control Department' || $_SESSION['department'] == 'Lens BIZ. Center' || $_SESSION['department'] == 'Lens Production Division' || $_SESSION['department'] == 'Lens Production Engineering Department') {
        $_SESSION['department'] = 'Lens';
    }
    
    if($_SESSION['position'] == 'M5' || $_SESSION['position'] == 'M5A' || $_SESSION['position'] == 'I5' || $_SESSION['position'] == 'I4') {
