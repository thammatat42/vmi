...
// die();
    ...
    || $_SESSION['department'] == 'Workplace/Security/She 1 Department' || $_SESSION['department'] == 'Workplace/Security/She 2 Department' || $_SESSION['department'] == 'MFD System Department'
    || $_SESSION['department'] == 'Automotive Manufacturing Engineer Department' || $_SESSION['department'] == 'IM Manufacturing Engineer Department' || $_SESSION['department'] == 'IM Process Engineering Department' || $_SESSION['department'] == 'Lens Manufacturing Engineer Department' || $_SESSION['department'] == 'Lens Process Engineering Department') {
        $_SESSION['department'] = 'Process Eng./AM/WSS';
    } 

    if($_SESSION['department'] == 'Changeable Lens Production 1 Department' || $_SESSION['department'] == 'Changeable Lens Production 2 Department' || $_SESSION['department'] == 'Lens BIZ. Center'
    || $_SESSION['department'] == 'Lens Production Control Department' || $_SESSION['department'] == 'Lens Production Division'
    || $_SESSION['department'] == 'AC Lens Production Department' || $_SESSION['department'] == 'Lens Production Engineering Department') {
        $_SESSION['department'] = 'Lens';
    }

    if($_SESSION['department'] == 'Material Control 1 Department') {
        $_SESSION['department'] = 'Material Control I Department';
    }
    
    if($_SESSION['position'] == 'M5' || $_SESSION['position'] == 'M5A' || $_SESSION['position'] == 'M6' || $_SESSION['position'] == 'M7' || $_SESSION['position'] == 'M7A' || $_SESSION['position'] == 'M8' || $_SESSION['position'] == 'M9' || $_SESSION['position'] == 'I5' || $_SESSION['position'] == 'I4' || $_SESSION['position'] == 'I6') {
        $_SESSION['position'] = 'M5/I4 up';
    }

    if($_SESSION['position'] == 'I1' || $_SESSION['position'] == 'I2') {
        $_SESSION['position'] = 'I1/I2';
    }
    ...
    if($_SESSION['emp_type'] == 'STT') {
        ...
        AND b.CATEGORY_TH like '%".$search."%' AND b.STATUS_CHG = '0' AND a.STATUS_CHG = 0");
        $stmt->execute();
        ...
        $stmt = $connect->prepare("select DISTINCT B.GROUP_ID, A.EMP_TYPE, A.EMP_LEVEL, A.DEPARTMENT, b.CATEGORY_TH,b.C_STOCK,b.IMG from tb_master as a INNER JOIN
        tb_group_master as b on a.GROUP_ID = b.GROUP_ID
        WHERE DEPARTMENT IN ('All','DIRECT','".$_SESSION['department']."') AND EMP_LEVEL IN ('All','".$_SESSION['position']."') AND EMP_TYPE IN ('All', 'Subcon,Student','SUBCON')
        AND b.CATEGORY_TH like '%".$search."%' AND b.STATUS_CHG = '0' AND a.STATUS_CHG = 0");
        $stmt->execute();
        $result = $stmt->fetchAll(PDO::FETCH_ASSOC);
    } else {
        ...
        $stmt = $connect->prepare("select DISTINCT B.GROUP_ID, A.EMP_TYPE, A.EMP_LEVEL, A.DEPARTMENT, b.CATEGORY_TH,b.C_STOCK,b.IMG from tb_master as a INNER JOIN
        tb_group_master as b on a.GROUP_ID = b.GROUP_ID
        WHERE DEPARTMENT IN ('All','DIRECT','".$_SESSION['department']."') AND EMP_LEVEL IN ('All','".$_SESSION['position']."') AND EMP_TYPE IN ('All', 'Subcon,Student')
        AND b.CATEGORY_TH like '%".$search."%' AND b.STATUS_CHG = '0' AND a.STATUS_CHG = 0");
        $stmt->execute();
        $result = $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
