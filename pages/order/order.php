                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="mt-2" hidden>
                                                        ...
                                                        <input class="btn btn-default" style="width: 80px" type="number" min="1" value="1" onKeyPress="if(this.value.length==4) return false;" id="input_number" readonly/>
                                                ...
                                                <table  id="order_logs" 
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>วันที่รับเข้า</th>
                                                            <th style="width: 200px">การเปลี่ยนแปลง</th>
                                                        </tr>
                                                    </thead>
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th></th>
                                                            <th>
                                                                <div class="btn-group" role="group" id="submit_mobile" hidden>
                                                                    <button type="submit" class="btn btn-success btn-lg" id="send_order" style="width: 50px">
    ...
    $(function() {
        ...
        $(document).on('click', '#positive', function(){
            ...
            if (input_number < check_stock){
                ...
                const set_value = $('#input_number').val(1);
            }
            ...
            if (check_this_year > 0){
                ...
                // if (input_number > 0){ --> Condition เดิม
                if (input_number > 1){
                    $("#show_value_bath").attr("hidden", false);
                    $("#show_value_free").attr("hidden", true);
                }
        ...
        function initDataTables(tableData) {
            ...
            var table = $('#order_logs').DataTable( {
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    var submit_hidden = $("#submit_mobile").attr("hidden", false);
