    ...
    <div class="row justify-content-right">
      ...
      <section class="col-lg-6">
        <div class="card shadow p-3 p-md-4 blur">
          <h1 class="text-center text-primary font-weight-bold gradient-text"><u>Change Password</u></h1>
          ...
          <div class="card-body">
            ...
            <form id="formRecover">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-block btn-gradient-border" id="button">Change password</button>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-center"> 
                      <a class="color" href="login.php">Sign IN?</a> 
                    </div>
            </form>
          </div>
        </div>
