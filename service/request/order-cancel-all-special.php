...
$stmt_check = $connect->prepare("SELECT CART_TRANS,GROUP_ID, SIZE, QTY, CATEGORY_TH, ORDER_BY FROM tb_products WHERE DATE(CURDATE()) >= RECEIVE_DATE AND STATUS_ID = 0 AND STATUS_CHG = 0");
$stmt_check->execute();
