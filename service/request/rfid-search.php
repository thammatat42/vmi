...
$stmt = $connect->prepare("SELECT B.CARD_ID,A.UID,A.FNAME,A.LNAME,A.IMG,A.EMAIL,B.POSITION,B.DEPARTMENT,B.LOCATION FROM tb_user AS A INNER JOIN tb_all_user AS B ON A.UID = B.UID WHERE B.CARD_ID = :search");
